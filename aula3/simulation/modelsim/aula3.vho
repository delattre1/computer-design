...
-- SW[5]	=>  Location: PIN_K16,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- LEDR[2]	=>  Location: PIN_R21,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- LEDR[6]	=>  Location: PIN_R22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[7]	=>  Location: PIN_AA13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[8]	=>  Location: PIN_N20,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- PC_OUT[1]	=>  Location: PIN_P22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PC_OUT[2]	=>  Location: PIN_R17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- KEY[0]	=>  Location: PIN_M16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[0]	=>  Location: PIN_P18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[1]	=>  Location: PIN_T22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[2]	=>  Location: PIN_T15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[3]	=>  Location: PIN_T19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[6]	=>  Location: PIN_T17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[7]	=>  Location: PIN_P19,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \PC|DOUT[2]~0_combout\ = ( \PC|DOUT\(2) & ( \PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT[1]~DUPLICATE_q\ ) ) ) # ( !\PC|DOUT\(2) & ( \PC|DOUT[0]~DUPLICATE_q\ & ( \PC|DOUT[1]~DUPLICATE_q\ ) ) ) # ( \PC|DOUT\(2) & ( !\PC|DOUT[0]~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \ROM1|memROM~1_combout\ = ( !\PC|DOUT\(0) & ( \PC|DOUT\(2) ) ) # ( \PC|DOUT\(0) & ( !\PC|DOUT\(2) ) )
...
-- Equation(s):
-- \ROM1|memROM~0_combout\ = ( \PC|DOUT[1]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) # ( !\PC|DOUT[1]~DUPLICATE_q\ & ( (\PC|DOUT\(2) & !\PC|DOUT\(0)) ) )
...
-- Equation(s):
-- \ULA1|Add0~18_cout\ = CARRY(( (!\PC|DOUT\(1) & (!\ROM1|memROM~1_combout\ $ (((!\PC|DOUT[0]~DUPLICATE_q\ & \PC|DOUT[2]~DUPLICATE_q\))))) # (\PC|DOUT\(1) & (((\PC|DOUT[2]~DUPLICATE_q\)))) ) + ( VCC ) + ( !VCC ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000000000000001000100001111011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( \REG1|DOUT\(0) ) + ( !\ROM1|memROM~0_combout\ $ (!\SW[6]~input_o\ $ (((!\ROM1|memROM~1_combout\) # (\PC|DOUT\(1))))) ) + ( \ULA1|Add0~18_cout\ ))
-- \ULA1|Add0~2\ = CARRY(( \REG1|DOUT\(0) ) + ( !\ROM1|memROM~0_combout\ $ (!\SW[6]~input_o\ $ (((!\ROM1|memROM~1_combout\) # (\PC|DOUT\(1))))) ) + ( \ULA1|Add0~18_cout\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010010111011010000000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ROM1|ALT_INV_memROM~1_combout\,
...
-- Equation(s):
-- \DECODER1|saida[2]~1_combout\ = ( !\PC|DOUT[2]~DUPLICATE_q\ & ( \PC|DOUT[0]~DUPLICATE_q\ ) ) # ( \PC|DOUT[2]~DUPLICATE_q\ & ( !\PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT[1]~DUPLICATE_q\ ) ) ) # ( !\PC|DOUT[2]~DUPLICATE_q\ & ( !\PC|DOUT[0]~DUPLICATE_q\ & ( 
...
PORT MAP (
	...
	ena => \DECODER1|saida[2]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REG1|DOUT\(0));
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( \REG1|DOUT\(1) ) + ( !\ROM1|memROM~0_combout\ $ (!\SW[7]~input_o\ $ (((!\ROM1|memROM~1_combout\) # (\PC|DOUT\(1))))) ) + ( \ULA1|Add0~2\ ))
-- \ULA1|Add0~6\ = CARRY(( \REG1|DOUT\(1) ) + ( !\ROM1|memROM~0_combout\ $ (!\SW[7]~input_o\ $ (((!\ROM1|memROM~1_combout\) # (\PC|DOUT\(1))))) ) + ( \ULA1|Add0~2\ ))
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( \REG1|DOUT\(2) ) + ( !\ROM1|memROM~0_combout\ $ (!\SW[8]~input_o\ $ (((!\ROM1|memROM~1_combout\) # (\PC|DOUT\(1))))) ) + ( \ULA1|Add0~6\ ))
-- \ULA1|Add0~10\ = CARRY(( \REG1|DOUT\(2) ) + ( !\ROM1|memROM~0_combout\ $ (!\SW[8]~input_o\ $ (((!\ROM1|memROM~1_combout\) # (\PC|DOUT\(1))))) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( \REG1|DOUT\(3) ) + ( !\ROM1|memROM~0_combout\ $ (!\SW[9]~input_o\ $ (((!\ROM1|memROM~1_combout\) # (\PC|DOUT\(1))))) ) + ( \ULA1|Add0~10\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010110011010011000000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \DECODER1|saida[0]~0_combout\ = (!\PC|DOUT[2]~DUPLICATE_q\ & ((\PC|DOUT\(1)) # (\PC|DOUT[0]~DUPLICATE_q\)))
